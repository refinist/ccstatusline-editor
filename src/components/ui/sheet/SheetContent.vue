...
interface SheetContentProps extends DialogContentProps {
  ...
  /** Hide the built-in floating close button (e.g. when the slot renders its own). */
  hideClose?: boolean;
  /** Override the overlay's class (e.g. to make it transparent or adjust the dim/blur). */
