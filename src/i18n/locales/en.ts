export default {
  ...
  wopt: {
    ...
    symbolHot: 'Working symbol',
    symbolFresh: 'Fresh symbol',
    symbolDraining: 'Draining symbol',
    symbolUrgent: 'Urgent symbol',
    symbolCold: 'Cold symbol',
    url: 'URL',
    linkText: 'Link text',
    customText: 'Text',
    customSymbol: 'Symbol',
  ...
  widgetDesc: {
    ...
    'git-ci-status':
      "Shows GitHub CI check status for the current branch's pull request",
    ...
    'cache-timer':
      'Shows time remaining on the prompt cache TTL (5m by default, 1h configurable)',
    ...
    'sandbox-status':
      'Shows whether Claude Code bash sandbox mode is enabled. Best effort when managed or CLI settings override local files.',
